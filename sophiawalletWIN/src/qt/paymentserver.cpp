...
const QString BITCOIN_IPC_PREFIX("SophiaCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click SophiaCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start SophiaCoin: click-to-pay handler");
    else
...
{
    // clicking on SophiaCoin: URLs creates FileOpen events on the Mac:
