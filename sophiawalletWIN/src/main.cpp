...
// Copyright (c) 2016-2017 The SophiaCoin developers http://SophiaCoin.org
...
//---genesis blocks -------------------------------------------------------------------------------------
uint256 hashGenesisBlock("0x00000a54055b541049bbac30a37bdc44ccd803e36ea86081a41191731cfa7cea");
uint256 hashGenesisBlockTestNet("0x00000a54055b541049bbac30a37bdc44ccd803e36ea86081a41191731cfa7cea");
//-------------------------------------------------------------------------------------------------------
uint256 MainHashMerkleRoot("0x3ce968df58f9c8a752306c4b7264afab93149dbc578bd08a42c446caaa6628bb");
//--time blocks ---------------------------------------
static const unsigned int timeGenesisBlock =1453651200;
static const unsigned int timeGenesisBlockTestNet =1453651200;
//-------nNonce -------------------------------------
static const unsigned int nNonceGenesis=9224;
static const unsigned int nNonceGenesisTestNet=9224;
//----------------------------------------------------
...
const string strMessageMagic = "SophiaCoin Signed Message:\n";
...
static const int64 nPremine = 21000000 * COIN;
...
static const int64 nTargetSpacing = 1 * 60; // sophiacoin every 60 seconds
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
        ...
        // Prevent blocks from too far in the future [since SophiaCoin version 2.0 at block 100,000]
...
unsigned char pchMessageStart[4] = { 0xc3, 0xf1, 0xa4, 0x05 };
        ...
        BOOST_FOREACH(CAddress& addr, vAddr)
        {
            ...
            if (addr.nTime > nSince && !pfrom->fGetAddr && vAddr.size() <= 10 && addr.IsRoutable())
            {
                // Relay to a limited number of other nodes
                {
                    ...
                    hashRand = HashSophia(BEGIN(hashRand), END(hashRand));
                    ...
                    BOOST_FOREACH(CNode* pnode, vNodes)
                    {
                        ...
                        hashKey = HashSophia(BEGIN(hashKey), END(hashKey));
...
bool ProcessMessages(CNode* pfrom)
{
    ...
    while (!pfrom->fDisconnect && it != pfrom->vRecvMsg.end()) {
        ...
        uint256 hash = HashSophia(vRecv.begin(), vRecv.begin() + nMessageSize);
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SophiaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SophiaCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("SophiaCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("SophiaCoin-miner");
    ...
    try { loop {
        ...
        printf("Running SophiaCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("SophiaCoinMiner terminated\n");
        throw;
    }
}
